...
parser.add_argument("--dataset", type=str, default="/Users/luxiaogen/Desktop/dataset/COVID_19_Radiography_Dataset") # 指定数据集名称，默认为"new_COVID_19_Radiography_Dataset"
...
transform_test = transforms.Compose([transforms.Resize([224, 224]),
                                        ...
                                        transforms.Normalize((0.3738, 0.3738, 0.3738),
                                                            (0.3240, 0.3240, 0.3240))])
trainset = datasets.ImageFolder(root=os.path.join(r'/Users/luxiaogen/Desktop/dataset/COVID_19_Radiography_Dataset', 'train'),
                                transform=transform_train)
testset = datasets.ImageFolder(root=os.path.join(r'/Users/luxiaogen/Desktop/dataset/COVID_19_Radiography_Dataset', 'val'),
